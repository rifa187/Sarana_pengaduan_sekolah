    ...
    <div class="bg-white rounded-[1.1rem] shadow-sm border border-slate-100 overflow-hidden mb-8 relative">
        ...
        <div class="p-8 sm:p-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Buat Laporan Card -->
                <a href="{{ route('complaints.create') }}" class="group block p-8 bg-white rounded-[1.5rem] border border-slate-200 hover:border-black hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
                ...
                <a href="{{ route('complaints.index') }}" class="group block p-8 bg-white rounded-[1rem] border border-slate-200 hover:border-grayr:shadow-lg hover:shadow-indigo-500/10 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
