        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div class="text-left">
                ...
                <div class="flex flex-col sm:flex-row items-start gap-4">
                    <a href="<?php echo e(route('login')); ?>" class="px-8 py-4 rounded-full bg-blue-600 text-white font-bold flex items-center gap-2.5 hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/25 hover:-translate-y-0.5 text-[15px]">
