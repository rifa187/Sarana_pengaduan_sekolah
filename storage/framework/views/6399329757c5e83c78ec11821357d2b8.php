...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center mt-5">
                <a href="<?php echo e(route('login')); ?>" class="text-[13.5px] text-slate-500 hover:text-blue-600 font-semibold transition-colors">
...
<?php /**PATH C:\laragon\www\Sarana_pengaduan_sekolah\resources\views/auth/register.blade.php ENDPATH**/ ?>