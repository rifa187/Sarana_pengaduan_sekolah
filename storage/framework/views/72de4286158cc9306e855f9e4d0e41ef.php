    ...
    <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden mb-8 relative">
        ...
        <div class="p-8 sm:p-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Buat Laporan Card -->
                <a href="<?php echo e(route('complaints.create')); ?>" class="group block p-8 bg-white rounded-[1.5rem] border border-slate-200 hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
                ...
                <a href="<?php echo e(route('complaints.index')); ?>" class="group block p-8 bg-white rounded-[1.5rem] border border-slate-200 hover:border-indigo-500 hover:shadow-lg hover:shadow-indigo-500/10 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
