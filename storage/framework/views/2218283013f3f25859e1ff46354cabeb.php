...
<div class="max-w-6xl mx-auto">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-200 text-slate-600 font-bold text-[13px] hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 transition-all shadow-sm group">
        ...
        <a href="<?php echo e(route('complaints.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full text-[14px] font-bold flex items-center justify-center gap-2 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5">
    ...
    <div class="bg-white rounded-[1.5rem] shadow-sm border border-slate-100 overflow-hidden">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-slate-700 divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors group">
                        ...
                        <td class="py-5 px-6">
                            <p class="font-bold text-[14.5px] text-slate-800 truncate max-w-xs md:max-w-md"><?php echo e($complaint->judul); ?></p>
                        </td>
                        ...
                        <td class="py-5 px-8 whitespace-nowrap text-right">
                            <a href="<?php echo e(route('complaints.show', $complaint->id)); ?>" class="inline-flex items-center px-5 py-2 rounded-full text-[13px] font-bold bg-white border border-slate-200 text-slate-700 group-hover:border-blue-200 group-hover:bg-blue-50 group-hover:text-blue-700 transition-all shadow-sm">Detail</a>
                        </td>
                    </tr>
        ...
        <div class="py-16 px-6 text-center text-slate-500">
            ...
            <div class="mt-6">
                <a href="<?php echo e(route('complaints.create')); ?>" class="inline-flex items-center justify-center bg-blue-50 text-blue-600 px-6 py-2.5 rounded-full font-bold border border-blue-100 hover:bg-blue-100 transition-colors">
                    Mulai Buat Laporan
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Sarana_pengaduan_sekolah\resources\views/student/complaints/index.blade.php ENDPATH**/ ?>