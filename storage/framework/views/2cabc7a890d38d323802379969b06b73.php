...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-[1.75rem] shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div class="px-8 py-5 border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <span class="text-sm font-semibold text-slate-400 bg-slate-100 px-3 py-1 rounded-full"><?php echo e($students->total()); ?> siswa</span>
            </div>
            <form method="GET" action="<?php echo e(route('admin.students.index')); ?>" class="flex gap-2 w-full sm:w-auto">
                ...
                <a href="<?php echo e(route('admin.students.index')); ?>" class="px-4 py-2.5 bg-slate-100 text-slate-600 text-sm font-semibold rounded-xl hover:bg-slate-200 transition">Reset</a>
                <?php endif; ?>
            </form>
        </div>
                    ...
                    <tr class="hover:bg-slate-50 transition-colors group">
                        <td class="px-8 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-bold text-slate-800"><?php echo e($student->name); ?></p>
                                    <p class="text-slate-400 text-xs"><?php echo e($student->email); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="px-4 py-4 text-slate-600 font-medium"><?php echo e($student->nis ?? '-'); ?></td>
                        <td class="px-4 py-4 text-slate-600 font-medium"><?php echo e($student->kelas ?? '-'); ?></td>
                        <td class="px-4 py-4 text-slate-600 font-medium"><?php echo e($student->jurusan ?? '-'); ?></td>
                        <td class="px-4 py-4 text-slate-600 font-medium"><?php echo e($student->no_hp ?? '-'); ?></td>
                        <td class="px-8 py-4 text-right whitespace-nowrap">
                            <div class="inline-flex items-center gap-2">
                                ...
                                <form method="POST" action="<?php echo e(route('admin.students.destroy', $student->id)); ?>"
                    ...
                    <tr>
                        <td colspan="6" class="py-16 text-center">
                            <div class="flex flex-col items-center gap-3 text-slate-400">
                                ...
                                <a href="<?php echo e(route('admin.students.create')); ?>" class="text-indigo-600 font-bold text-sm hover:underline">+ Tambah Siswa Baru</a>
                            </div>
                        </td>
                    </tr>
                    <?php endif; ?>
    ...
    <div class="mt-6">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-slate-800 transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Sarana_pengaduan_sekolah\resources\views/admin/students/index.blade.php ENDPATH**/ ?>